...
// 	const API_URL = "https://dnis-api.onrender.com/";

// 	// Función para verificar si el DNI existe en la respuesta de la API
// 	function verificarDNI(dni) {
// 		return fetch(API_URL)
// 			.then(res => res.json())
// 			.then(data => {
// 				// Verificar si el DNI existe en la respuesta de la API
// 				return data.some(item => item.dnis === dni);
// 			});
// 	}

// 	// Agregar un evento de escucha para el envío del formulario
// 	document.querySelector('tu-formulario').addEventListener('submit', function(event) {
...
// 			.then(existe => {
// 				if (existe) {
// 					// Si el DNI existe, impedir el envío del formulario
// 					alert('El DNI ya existe. No se puede enviar el formulario.');
